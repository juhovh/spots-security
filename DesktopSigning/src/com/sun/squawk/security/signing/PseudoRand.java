...
public final class PseudoRand {
    ...
    private static byte[] seed =
	    { (byte) 0xC9, (byte) 0x0F, (byte) 0xDA, (byte) 0xA2, (byte) 0x21,
		    (byte) 0x68, (byte) 0xC2, (byte) 0x34, (byte) 0xC4,
		    (byte) 0xC6, (byte) 0x62, (byte) 0x8B, (byte) 0x80,
		    (byte) 0xDC, (byte) 0x1C, (byte) 0xD1 };
    ...
    public PseudoRand() throws CryptoException {
	if (md != null)
	    return;
    ...
    /**
         * This does a reasonable job of producing unpredictable random data by
         * using a one way hash as a mixing function and the current time in
         * milliseconds as a source of entropy.
         * 
         * @param b
    ...
    /**
         ...
         * 
         * @param b
         *                initial data to use as the seed
         * @param off
         *                offset into the provided buffer
         * @param len
	...
	md.doFinal(timeTmp, 0, timeTmp.length, seed, 0);
    }
}
