...
public class ClearTrustedKeysCommand extends AbstractClientCommand {
    public ClearTrustedKeysCommand() {
    }
    ...
    public Object execute(ISpotClientCommandHelper helper) throws IOException {
        ...
        // Utils.log("Executing cleartrustedkeys");
        at.sendAdminCommand(SpotClientCryptoExtension.CLEAR_TRUSTED_KEYS_CMD);
        ...
        try {
            ...
            throw new IOException("ClearTrustedKeysCommand: could not parse " +
                    "response (" + ex + ")\n" +
        ...
        if (((String) retVal).startsWith("Fail"))
            throw new IOException("ClearTrustedKeysCommand " + retVal);
    ...
    public String getName() {
        return "cleartrustedkeys";
    }
    
    public String getUsage() {
        return "cleartrustedkeys -- clears the SPOTs key store";
    }
}
